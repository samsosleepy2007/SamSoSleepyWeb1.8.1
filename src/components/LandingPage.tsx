      ...
      <div className="text-center">
        ...
        <div className="max-w-2xl mx-auto deltarune-card p-8">
          <p className="text-gray-300 text-lg leading-relaxed mb-4">
            ...
            This website is for sharing game information and content. This website does not intend to infringe on anyone's copyright. If you have any work of yours, please contact me. I will be happy to remove it.
          </p>
